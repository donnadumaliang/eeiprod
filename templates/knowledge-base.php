...
<?php if($_SESSION['user_type'] != 'Requestor'){ ?>
  ...
  <div class="row">
    ...
    <span class="no-margin" right-align>
    <?php if($_SESSION['user_type'] == 'Administrator') {?>
      <a id="addfaq" href="faq-add.php" class="waves-effect waves-light btn-small hide-on-small-only"><i id="kb" class="tiny material-icons left">book</i>Add New Article</a>
      <a id="addfaq" href="#modal-new-subcategory" class="waves-effect waves-light btn-small modal-trigger hide-on-small-only"><i id="kb" class="tiny material-icons left">library_books</i>Add Article Subcategory</a>
    <?php } ?>
    </span>
  </div>
</div>
    ...
    <div id="modal-new-subcategory" class="modal">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button class="btn blue-btn" id="" type="submit" name="submit">Create</button>
          <a href="knowledgebase.php" class="btn modal-action modal-close red-btn">Close</a>
        </div>
      </form>
    </div>
  </div>
      ...
      <h5>Browse Help Topics</h5>
        <div class="col s12 m4 l4">
          <div class="card" id="technicals-card">
            ...
            <div class="card-content" id="kb">
              <span class="card-title">Technicals</span>
              <p id="kb">CPU, Mouse, Keyboard, Monitor, Printers, Scanners, Tablets, etc.</p>
            </div>
            <div class="card-action">
              <a href="faq-list.php?view=technicals">Technical FAQs</a>
        ...
        <div class="col s12 m4 l4">
          <div class="card" id="access-card">
            ...
            <div class="card-action">
              <a href="faq-list.php?view=access">Access FAQs</a>
              <?php include 'faq-sorter.php'; ?>
            </div>
          </div>
        </div>
        <div class="col s12 m4 l4">
          <div class="card" id="network-card">
            ...
            <div class="card-action">
              <a href="faq-list.php?view=network">Network FAQs</a>
              <?php include 'faq-sorter.php'; ?>
            </div>
          </div>
        </div>
