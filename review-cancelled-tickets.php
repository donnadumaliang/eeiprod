    ...
    <div class="col s12 m12 l12" id="content">
      <div class="main-content">
        <div class="row col s12 m12 l12 table-header">
          <span class="table-title">Cancelled Tickets</span>
          <!-- Badge Counter -->
          <div class="count">
          <?php
            if($_SESSION['user_type'] == "Administrator"){
              $query = "SELECT COUNT(*) as count FROM ticket_t WHERE ticket_status=9";
            }
          ...
          <div id="breadcrumb">
            ...
            <a href="#!" class="breadcrumb">Cancelled Tickets Reviewed</a>
          </div>
                ...
                <table id="datatable" class="striped">
                    <thead>
                        <tr>
                          ...
                          <th class="col-ticketno">Status</th>
                          <th class="col-ticketno">Type</th>
                    ...
                    <tbody>
                    <?php
                     $query = "SELECT * FROM ticket_t LEFT JOIN service_ticket_t USING (ticket_id) LEFT JOIN user_access_ticket_t USING (ticket_id) LEFT JOIN sla_t sev ON sev.id = ticket_t.severity_level LEFT JOIN ticket_status_t stat ON stat.status_id = ticket_t.ticket_status WHERE ticket_t.ticket_status=4 OR ticket_t.ticket_status=9";
                     $stat = 'Cancelled';
                     ...
                     while($row = mysqli_fetch_assoc($result)){
                        ...
                        ?>
                         <tr class='clickable-row' data-href="details.php?id=<?php echo $row['ticket_id']?>">
                           ...
                           <td class="col-title"> <?php echo $row['ticket_status']?>   </td>
                           <td class="col-title"> <?php echo $row['ticket_type']?>   </td>
