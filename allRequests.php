    ...
    <div class="col s12 m12 l12" id="content">
      <div class="main-content">
        <div class="col s12 m12 l12 table-header">
          ...
          <?php
            $id = $_SESSION['user_id'];
            $query = "SELECT COUNT(*) as count FROM ticket_t LEFT JOIN user_access_ticket_t USING (ticket_id) WHERE user_access_ticket_t.approver = $id OR user_access_ticket_t.checker = $id";
          ...
          <div class="col s12" id="breadcrumb">
            ...
            <div class="material-table">
              ...
              <table id="datatable" class="striped">
                  ...
                  <?php
                  $id = $_SESSION['user_id'];
                  $query = "SELECT * FROM ticket_t LEFT JOIN user_access_ticket_t USING (ticket_id) LEFT JOIN request_details_t USING(ticket_id) LEFT JOIN sla_t sev ON sev.id = ticket_t.severity_level WHERE user_access_ticket_t.approver = $id OR user_access_ticket_t.checker = $id";
